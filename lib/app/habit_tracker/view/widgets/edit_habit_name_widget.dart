...
import 'package:howbadami/app/habit_tracker/repo/user_habit_entity.dart';
import 'package:howbadami/app/habit_tracker/view/providers/user_habit_provider.dart';
import 'package:howbadami/core/constants/app_dimensions.dart';
import 'package:howbadami/core/constants/app_formatters.dart';
...
class _EditHabitNameWidgetState extends State<EditHabitNameWidget> {
  ...
  void showSnackBarFailure() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text(Words.nameChangeFailed, style: AppTextStyles.m),
        showCloseIcon: true,
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    UserHabitEntity userHabit = Provider.of<UserHabitProvider>(
      context,
    ).userHabit!;
    ...
    Future<void> saveValue() async {
      if (formKey.currentState!.validate()) {
        UserHabitProvider userProvider = Provider.of<UserHabitProvider>(
          context,
          listen: false,
        );
