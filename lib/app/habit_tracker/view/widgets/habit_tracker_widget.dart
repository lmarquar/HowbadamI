...
import 'package:howbadami/app/habit_tracker/view/widgets/edit_habit_name_widget.dart';
...
class HabitTrackerWidget extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        Expanded(child: EditHabitNameWidget()),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: List.generate(nbWeeks, (rowIndex) {
                          return Column(
                            children: List.generate(nbDays, (columnIndex) {
                              int daysAgo = calculateDaysAgo(
                                rowIndex,
                                columnIndex,
                              );
                              Color boxColor;
  ...
  int calculateDaysAgo(int rowIndex, int columnIndex) {
    ...
    DateTime targetWeekStart = startOfThisWeek.subtract(
      Duration(days: (maxWeekIndex - rowIndex) * maxDayIndex),
    );
