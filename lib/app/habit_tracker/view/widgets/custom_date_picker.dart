    ...
    return Padding(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          UserHabitProvider userHabitProvider = Provider.of<UserHabitProvider>(
            context,
            listen: false,
          );
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                '$dayOfMonth',
                style: AppTextStyles.lBold.copyWith(
                  color: isSelectable ? null : Colors.white10,
                ),
              ),
            ),
          );
